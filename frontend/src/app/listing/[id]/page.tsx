...
export default function ListingDetail({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-8">
      <h1 className="text-3xl font-semibold mb-4">{listing.name || 'Unnamed Property'}</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="p-4 border border-border rounded-lg bg-white">
          ...
          <div className="font-semibold">₹{listing.price_min} Lakhs</div>
        </div>
        <div className="p-4 border border-border rounded-lg bg-white">
        ...
        <div className="p-4 border border-border rounded-lg bg-white">
          <div className="text-sm text-secondary">Furnishing</div>
          <div className="font-semibold capitalize">{listing.furnishing || 'N/A'}</div>
        </div>
      </div>
